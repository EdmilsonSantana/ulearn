      ...
      $.ajax ({
        ...
        { var return_data = $.parseJSON( data );
          if(return_data.status='true'){
            ...
            $('.lecture-'+lid + ' .deletelecture').show();
