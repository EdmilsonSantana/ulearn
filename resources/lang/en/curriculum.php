...
<p>Set the price of your course and complete your premium instructor application so we can pay you. Or skip this step to leave your course free.</p>",  
 ...
 "Library"			=> "Adicionar da Biblioteca",  
 "resource"			=> "Recurso Externo",  
 "curriculum_upload"			=> "Enviar arquivo MP3/WAV",  
 "curriculum_pdf"			=> "Enviar arquivo PDF/DOC",  
 "curriculum_pdfdoc"			=> "Enviar arquivo PDF/DOC",  
 "curriculum_doc"			=> "Upload de Documento PDF/DOCX",  
 "no_library"			=> "A biblioteca está vazia",  
 "Link"			=> "Link",  
 "Add_Link"			=> "Adicionar Link",  
 "Edit_Content"			=> "Editar Conteúdo",  
 "Add_Resource"			=> "Adicionar Recurso",  
 "lecture_process"			=> "O cadastro da atividade está sendo processado. O conteúdo ficará disponível em breve.",  
 "Audio_Preview"			=> "Áudio",  
 "browser_support"			=> "Seu navegador não suporta a reprodução de áudio.",  
 "Resources"			=> "Recursos",  
 ...
 "True"			=> "True",  
 "False"			=> "False",  
 "Add_Lecture"			=> "Adicionar Atividade",  
 "Add_Quiz"			=> "Add Quiz",  
 "New_Lecture"			=> "Atividade",  
 "New_Quiz"			=> "New Quiz",  
 "quiz_title"			=> "Título",  
 ...
 "use_lecture_video"			=> "Enviar arquivo MP4/MOV/AVI/FLV",  
 "Approved"			=> "Approved",  
 ...
 "test_video_preview"			=> "Prévia do Vídeo",  
 "lang_id"			=> "Lang Id",  
...
<p>Set the price of your course and complete your premium instructor application so we can pay you. Or skip this step to leave your course free.</p>",  
 ...
 "section_message"			=> "Adicione uma seção antes de adicionar a atividade.", 
 "process_in_progress"			=> "Aguarde até que o processo seja concluído.", 
 ...
 "audio_message"			=> "A atividade está sendo processada. O seu áudio ficará disponível em breve.",  
 "curriculum_empty"			=> "Valores vazios não são permitidos.",  
 "curriculum_text_empty"			=> "Por favor, informe o texto.",  
 ...
 "curriculum_description"			=> "Por favor, informe a descrição.",  
 "curriculum_quiz_length"			=> "Quiz name Should contain atleast 2 letters",  
 "curriculum_lecture_name"			=> "Por favor, informe o nome da atividade.",  
 "curriculum_lecture_ch_length"			=> "Por favor, informe no mínimo 2 caracteres",  
 "curriculum_section_ch_length"			=> "Por favor, informe no mínimo 2 caracteres", 
 "curriculum_section_name"			=> "Por favor, informe o nome da seção.",  
 "lecture_file_not_allowed"			=> "File Type not Allowed!!! Upload .pdf .doc .docx files",  
 "lecture_file_process"			=> "Processando documento. Por favor, aguarde...",  
 "lecture_pdf_file"			=> "Erro: Tipo de arquivo não permitido. Apenas é permitido o envio de documentos PDF.",  
 "lecture_audio_file"			=> "Erro: Tipo de arquivo não permitido. Apenas é permitido o envio de arquivos .mp3 ou .wav.",  
 "audio_process"			=> "Processando áudio. Por favor, aguarde...",  
 "lecture_video_file"			=> "Erro: Tipo de arquivo não permitido. Apenas é permitido o envio dos seguintes tipos de arquivo: .mp4, .avi, .mkv e .flv.",  
 "video_process"			=> "Processando vídeo. Por favor, aguarde...",  
 ...
 "res_invalid_url"			=> "Formato de URL inválido.",  
 );
?>